...
Purpose: Capture user intent, tone, role, format, and optionally record the user’s preferred model and tools. This creates the Prompt Plan Clipboard.
...
Prompt Plan Clipboard (Build in Progress) (flattened)
