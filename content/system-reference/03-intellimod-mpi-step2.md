...
Purpose
Transform the Prompt Plan Clipboard into a high-quality prompt draft. Embed all logic, roles, tone, and constraints. Apply reasoning silently (Tier 1) or visibly (Tier 2+).
...
- Use the Prompt Plan Clipboard from Step 1.
...
Prompt Plan Clipboard (v1.2 Output Preview) (flattened)
- Intent: [stored]
- Tone: [stored]
- Role: [stored]
- Format: [stored]
